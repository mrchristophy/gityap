...
ALTER TABLE "public"."column" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."column_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: connection connection_account_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."connection"
    ADD CONSTRAINT "connection_account_id_key" UNIQUE ("account_id");
...
--
-- Name: board board_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."board"
    ADD CONSTRAINT "board_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");


--
-- Name: column column_board_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."column"
    ADD CONSTRAINT "column_board_id_fkey" FOREIGN KEY ("board_id") REFERENCES "public"."board"("id");


--
-- Name: column column_connection_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."column"
    ADD CONSTRAINT "column_connection_id_fkey" FOREIGN KEY ("connection_id") REFERENCES "public"."connection"("id");


--
-- Name: column column_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."column"
    ADD CONSTRAINT "column_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");


--
-- Name: connection connection_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."connection"
    ADD CONSTRAINT "connection_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");


--
-- Name: board Boards are viewable by the users that created them; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Boards are viewable by the users that created them" ON "public"."board" FOR SELECT USING (("auth"."uid"() = "user_id"));


--
-- Name: column Connections are viewable by users that created them; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Connections are viewable by users that created them" ON "public"."column" FOR SELECT USING (("auth"."uid"() = "user_id"));


--
-- Name: connection Connections are viewable by users that created them; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Connections are viewable by users that created them" ON "public"."connection" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));


--
-- Name: board Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable insert for authenticated users only" ON "public"."board" FOR INSERT TO "authenticated" WITH CHECK (true);


--
-- Name: column Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable insert for authenticated users only" ON "public"."column" FOR INSERT TO "authenticated" WITH CHECK (true);


--
-- Name: connection Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: board; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."board" ENABLE ROW LEVEL SECURITY;

--
-- Name: column; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "column"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE "column_id_seq"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE "public"."column_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."column_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."column_id_seq" TO "service_role";
